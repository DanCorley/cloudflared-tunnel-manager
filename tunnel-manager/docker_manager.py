...
class DockerManager:
    ...
    def get_container_labels(self, container):
        ...
        try:
            ...
            # Set enabled state based on cloudflare.enabled label
            cloudflare_labels['enabled'] = str(labels.get('cloudflare.enabled', '').lower() == 'true').lower()
    ...
    def handle_container_event(self, event, callback):
